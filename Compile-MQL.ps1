...
Param( $FileToCompile = "C:\Users\sec\AppData\Roaming\MetaQuotes\Terminal\F762D69EEEA9B4430D7F17C82167C844\MQL5\Experts\Test.mq5")
...
& "C:\Program Files\MetaTrader\metaeditor64.exe" /compile:"$FileToCompile" /log:"$LogFile" /inc:"C:\Users\sec\AppData\Roaming\MetaQuotes\Terminal\F762D69EEEA9B4430D7F17C82167C844\MQL5" | Out-Null
...
if ( $WhichColor -eq "Green") { & "C:\Program Files\MetaTrader\terminal64.exe" }